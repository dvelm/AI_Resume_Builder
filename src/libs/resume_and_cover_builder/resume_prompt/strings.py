from src.libs.resume_and_cover_builder.template_base import prompt_education_template, prompt_working_experience_template, prompt_projects_template, prompt_achievements_template, prompt_certifications_template, prompt_additional_skills_template # Removed prompt_header_template

# prompt_header is no longer used as header HTML is generated directly in Python code.
