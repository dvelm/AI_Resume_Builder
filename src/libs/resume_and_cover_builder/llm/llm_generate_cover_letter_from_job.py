...
# Remove direct client/embedding imports if llm_client is passed in
...
from src.libs.resume_and_cover_builder.improved_prompts import improved_cover_letter_prompt
...
class LLMCoverLetterJobDescription:
    ...
    def __init__(self, llm_client: Any, strings: Any):
        ...
        # TODO: Handle embeddings based on LLM_MODEL_TYPE if needed
        # Commenting out direct OpenAIEmbeddings instantiation for now
    ...
    def generate_cover_letter(self, language: str = "English") -> str:
        """
        Generate the cover letter based on the job description and resume in the specified language.
        Returns:
            str: The generated cover letter
        """
        logger.debug(f"Starting cover letter generation in {language}...")
        # Use improved cover letter prompt for better quality
        prompt_template = self._preprocess_template_string(improved_cover_letter_prompt)
        ...
        input_data = {
            ...
            "resume": self.resume,
            "language": language,
            "template": self.strings.cover_letter_template
        }
        ...
        return output.strip() # Return stripped HTML
