...
"""
# prompt_header_template is no longer used as header HTML is generated directly in Python code.
...
```
IMPORTANT: Do NOT include the section tag or h2 heading in your output. The section and heading will be added separately. Provide only the inner content as shown in the template.
...
```
IMPORTANT: Do NOT include inline styles in your output. All styling should be handled by CSS classes. Provide only the HTML structure.
...
<section id="skills-languages">
    ...
    <div class="two-column">
      ...
      <ul class="compact-list">
          ...
          <li>[Specific Skill or Technology]</li>
          <li>[Specific Skill or Technology]</li>
          <li><strong>Languages:</strong> [List Languages here, e.g., English (Fluent), Spanish (Intermediate)]</li>
          <li><strong>Interests:</strong> [List Interests here, e.g., Machine Learning, Cybersecurity]</li>
      </ul>
    </div>
</section>
'''
