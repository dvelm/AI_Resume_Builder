...
Thank you for your interest in contributing to AI Resume Builder. This document provides guidelines for contributing to the project.
...
- Planning meeting for `release/v4.1.0` with release scope and milestone objectives set by the maintainers. Release and maintainer meeting agendas and schedules are posted on the project repository [wiki](https://github.com/dvelm/AI_Resume_Builder/wiki) and shared in the `#releases` channel on Discord.
- `release/v4.0.0` release candidate ready for release
- `release/v4.0.0` merge into `develop`, `main`
- tag `main` as `release/v4.0.0`
- `release/v4.0.0` published to dvelm/AI_Resume_Builder/releases and PyPI as a package with release documentation
