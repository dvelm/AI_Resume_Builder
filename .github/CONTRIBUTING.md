...
Welcome to the AI Resume Builder Contributing Guide and Issues Tracker! To keep things organized and ensure issues are resolved quickly, please follow the guidelines below when submitting a bug report, feature request, or any other issue.
...
The employers who you are applying to are not looking for candidates who need someone to hold their hand and do everything for them, they are not your parents, they are your potential bosses; they will be expecting you to be able to solve simple problems on your own, the project maintainers expect the same of you.

Please do not beg in the issues tracker, discussions or chat. We are here to provide you with a tool for you to go out and find a job on your own. We will try to have instructions for all steps of the process, but you must read the docs, learn on your own, and understand that this is an open-source project run by volunteers. It will require you to do some work of your own.
...
Check the project documentation and README for detailed information on how to use the application.

Join the GitHub Discussions to check with the community about issues and ask for help with issues. If a contributor or other community member is available, a conversation will likely resolve your small issues and configuration problems faster than using this issues tracker would.
...
- If you're unsure whether something is a bug or if you're seeking clarification on functionality, you can ask a question. The best place to ask a question is in the GitHub Discussions section. If you are asking a question on GitHub Issues, please make sure to label your issue as a question.
